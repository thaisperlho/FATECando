<%-- 
    ...
    Created on : 27 de mar. de 2023, 10:48:11
              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="buscarMedico.jsp">Buscar</a></li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
            ...
            <div class="row">
              ...
              <div class="col-6">
                  <form action="" method="post">
                      <legend>Busca de Medico</legend>
                      <div class="input-group mb-3">
                          <input name="txtNome" type="text" class="form-control" placeholder="Digite o nome do medico" aria-label="NomePaciente" aria-describedby="basic-addon1">
